 ...
 */
module taxi_eth_phy_1g_basex_us_gt #
(
...
assign gt_rxbufreset = 1'b0; // TODO
...
if (SIM) begin : xcvr
    ...
    taxi_eth_phy_1g_basex_us_gty_full
    gt_ch_inst (
        // Common
        ...
        .rxclkcorcnt_out(gt_rxclkcorcnt),
    ...
    taxi_eth_phy_1g_basex_us_gth_full
    gt_ch_inst (
        // Common
        .gtpowergood_out(xcvr_gtpowergood_out),
    ...
    taxi_eth_phy_1g_basex_us_gty_ch
    gt_ch_inst (
        // Common
        .gtpowergood_out(xcvr_gtpowergood_out),
    ...
    taxi_eth_phy_1g_basex_us_gth_ch
    gt_ch_inst (
        // Common
        .gtpowergood_out(xcvr_gtpowergood_out),
